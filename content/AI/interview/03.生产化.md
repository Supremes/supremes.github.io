---
title: Agent 生产化：评测、可观测性、可靠性、安全与性能
date: 2026-09-09
tags: [interview, agent, eval, observability, trajectory, reliability, retry, security, authorization, performance, cost]
---

# Agent 生产化：评测、可观测性、可靠性、安全与性能

这一组回答「Agent 怎么上线」：评测证明它有效，可观测性留下证据，可靠性处理出错之后的事，安全约束它能碰什么，性能与成本决定它值不值。重试与 Trace 的耦合放在「可靠性与生产化」一节。
